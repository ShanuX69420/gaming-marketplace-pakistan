      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          ...
          <div className="col-span-1 md:col-span-2">
            ...
            <p className="text-gray-600 mb-4 max-w-md">
              Pakistan's trusted marketplace for buying and selling game accounts, 
              in-game currency, top-ups, and gaming services. Safe, secure, and reliable.
            </p>
          ...
          <div>
            ...
            <ul className="space-y-3">
              ...
              <li>
                <Link href="/safety" className="text-gray-600 hover:text-primary-600">
                  Safety Guide
                </Link>
              </li>
            </ul>
        ...
        <div className="mt-8 pt-8 border-t border-gray-200">
          <p className="text-center text-gray-600">
            © 2024 Gaming Market Pakistan. All rights reserved.
          </p>
        </div>
      </div>
    </footer>
